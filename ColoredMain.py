...
if __name__ == "__main__":
    ...
    if len(open("colored_results/" + str(graph.split(".")[0]) + "_" + str(algorithm) + '.txt').readlines()) > 1:
        prev_agents = int(open("colored_results/" + str(graph.split(".")[0]) + "_" + str(algorithm) + '.txt').readlines()[-2].split("a")[0])
        prev_suffix = int(open("colored_results/" + str(graph.split(".")[0]) + "_" + str(algorithm) + '.txt').readlines()[-2].split("_")[1].split(".")[0])
    else:
