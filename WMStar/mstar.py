...
from WMStar.Mstar_utils import phi, dynamic_tsp
from WMStar.classes import Config_key, Config_value, FastContainsPriorityQueue
from utils import dijkstra_predecessor_and_distance
...
class Mstar:
    def __init__(self, graph, v_I, v_W, v_F, tsp_cache):
        ...
        self.configurations[v_I_key] = Config_value(cost=0)
