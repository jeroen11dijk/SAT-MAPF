...
if __name__ == '__main__':
    ...
    #         res = 0
    #         ten = 0
    # {0: [4, 1], 1: [0, 5, 2], 2: [1, 6, 3], 3: [2, 7], 4: [0, 8, 5], 5: [1, 4, 9, 6], 6: [2, 5, 10, 7], 7: [3, 6], 8: [4, 12, 9], 9: [5, 8, 13, 10], 10: [6, 9, 14], 12: [8, 13], 13: [9, 12, 14], 14: [10, 13, 15], 15: [14]}
    # [6, 7, 14, 15, 10, 1] [5, 0, 13, 9, 3, 2]
    problem = BaseProblem()
    problem.graph = {0: [6, 1], 1: [0, 7, 2], 2: [1, 8], 4: [10], 6: [0, 12, 7], 7: [1, 6, 8], 8: [2, 7, 14, 9], 9: [8, 15, 10], 10: [4, 9, 16], 12: [6, 18], 14: [8, 20, 15], 15: [9, 14, 16], 16: [10, 15, 22, 17], 17: [16, 23], 18: [12, 24], 20: [14, 26], 22: [16, 23], 23: [17, 22, 29], 24: [18, 30, 25], 25: [24, 31, 26], 26: [20, 25, 32, 27], 27: [26, 33], 29: [23], 30: [24, 31], 31: [25, 30, 32], 32: [26, 31, 33], 33: [27, 32]}
    problem.starts = [26, 7, 18]
    problem.goals = [14, 25, 24]
    problem.n_agents = 3
