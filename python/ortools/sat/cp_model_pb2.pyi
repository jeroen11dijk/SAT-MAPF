...
class IntervalConstraintProto(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        size: builtins.int = ...,
        start_view: global___LinearExpressionProto | None = ...,
        end_view: global___LinearExpressionProto | None = ...,
        size_view: global___LinearExpressionProto | None = ...,
    ) -> None: ...
...
class ReservoirConstraintProto(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        min_level: builtins.int = ...,
        max_level: builtins.int = ...,
        times: collections.abc.Iterable[builtins.int] | None = ...,
        demands: collections.abc.Iterable[builtins.int] | None = ...,
        actives: collections.abc.Iterable[builtins.int] | None = ...,
    ) -> None: ...
...
class ConstraintProto(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        int_div: global___IntegerArgumentProto | None = ...,
        int_mod: global___IntegerArgumentProto | None = ...,
        int_max: global___IntegerArgumentProto | None = ...,
        lin_max: global___LinearArgumentProto | None = ...,
        int_min: global___IntegerArgumentProto | None = ...,
        lin_min: global___LinearArgumentProto | None = ...,
        int_prod: global___IntegerArgumentProto | None = ...,
    ...
    def HasField(self, field_name: typing_extensions.Literal["all_diff", b"all_diff", "at_most_one", b"at_most_one", "automaton", b"automaton", "bool_and", b"bool_and", "bool_or", b"bool_or", "bool_xor", b"bool_xor", "circuit", b"circuit", "constraint", b"constraint", "cumulative", b"cumulative", "element", b"element", "exactly_one", b"exactly_one", "int_div", b"int_div", "int_max", b"int_max", "int_min", b"int_min", "int_mod", b"int_mod", "int_prod", b"int_prod", "interval", b"interval", "inverse", b"inverse", "lin_max", b"lin_max", "lin_min", b"lin_min", "linear", b"linear", "no_overlap", b"no_overlap", "no_overlap_2d", b"no_overlap_2d", "reservoir", b"reservoir", "routes", b"routes", "table", b"table"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["all_diff", b"all_diff", "at_most_one", b"at_most_one", "automaton", b"automaton", "bool_and", b"bool_and", "bool_or", b"bool_or", "bool_xor", b"bool_xor", "circuit", b"circuit", "constraint", b"constraint", "cumulative", b"cumulative", "element", b"element", "enforcement_literal", b"enforcement_literal", "exactly_one", b"exactly_one", "int_div", b"int_div", "int_max", b"int_max", "int_min", b"int_min", "int_mod", b"int_mod", "int_prod", b"int_prod", "interval", b"interval", "inverse", b"inverse", "lin_max", b"lin_max", "lin_min", b"lin_min", "linear", b"linear", "name", b"name", "no_overlap", b"no_overlap", "no_overlap_2d", b"no_overlap_2d", "reservoir", b"reservoir", "routes", b"routes", "table", b"table"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["constraint", b"constraint"]) -> typing_extensions.Literal["bool_or", "bool_and", "at_most_one", "exactly_one", "bool_xor", "int_div", "int_mod", "int_max", "lin_max", "int_min", "lin_min", "int_prod", "linear", "all_diff", "element", "circuit", "routes", "table", "automaton", "inverse", "reservoir", "interval", "no_overlap", "no_overlap_2d", "cumulative"] | None: ...
...
class CpSolverResponse(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        objective_value: builtins.float = ...,
        best_objective_bound: builtins.float = ...,
        solution_lower_bounds: collections.abc.Iterable[builtins.int] | None = ...,
        solution_upper_bounds: collections.abc.Iterable[builtins.int] | None = ...,
