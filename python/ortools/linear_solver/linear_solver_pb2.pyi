...
class MPSolutionResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["best_objective_bound", b"best_objective_bound", "objective_value", b"objective_value", "status", b"status", "status_str", b"status_str"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["additional_solutions", b"additional_solutions", "best_objective_bound", b"best_objective_bound", "dual_value", b"dual_value", "objective_value", b"objective_value", "reduced_cost", b"reduced_cost", "status", b"status", "status_str", b"status_str", "variable_value", b"variable_value"]) -> None: ...
