...
class SimpleMinCostFlow(MinCostFlowBase):
    ...
    def SetArcCapacity(self, arc: "operations_research::ArcIndex", capacity: "operations_research::FlowQuantity") -> "void":
        return _pywrapgraph.SimpleMinCostFlow_SetArcCapacity(self, arc, capacity)

    def SetArcCost(self, arc: "operations_research::ArcIndex", cost: "operations_research::CostValue") -> "void":
        return _pywrapgraph.SimpleMinCostFlow_SetArcCost(self, arc, cost)
