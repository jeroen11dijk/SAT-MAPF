...
class RoutingSearchParameters(google.protobuf.message.Message):
    ...
    class _SchedulingSolverEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[RoutingSearchParameters._SchedulingSolver.ValueType], builtins.type):  # noqa: F821
        ...
        UNSET: RoutingSearchParameters._SchedulingSolver.ValueType  # 0
        GLOP: RoutingSearchParameters._SchedulingSolver.ValueType  # 1
        CP_SAT: RoutingSearchParameters._SchedulingSolver.ValueType  # 2
    ...
    UNSET: RoutingSearchParameters.SchedulingSolver.ValueType  # 0
    GLOP: RoutingSearchParameters.SchedulingSolver.ValueType  # 1
    CP_SAT: RoutingSearchParameters.SchedulingSolver.ValueType  # 2
