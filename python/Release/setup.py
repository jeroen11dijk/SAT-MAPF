...
setup(
    ...
    package_data={
        ...
        'ortools.init':['_pywrapinit.so'],
        'ortools.algorithms':['_pywrapknapsack_solver.so'],
        'ortools.graph':['_pywrapgraph.so'],
        'ortools.constraint_solver':['_pywrapcp.so', '*.pyi'],
        'ortools.linear_solver':['_pywraplp.so', '*.pyi'],
        'ortools.sat':['_pywrapsat.so', '*.pyi'],
        'ortools.data':['_pywraprcpsp.so', '*.pyi'],
        'ortools.util':['_sorted_interval_list.so', '*.pyi'],
    },
